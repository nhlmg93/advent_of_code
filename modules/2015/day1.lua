...
--- Calculates the final floor based on parentheses instructions
--- @param instructions string The string of parentheses instructions
--- @return integer floor The final floor
...
--- Finds the position where floor first becomes -1
--- @param instructions string The string of parentheses instructions
--- @return integer|nil position The position where floor becomes -1, or nil if never reached
